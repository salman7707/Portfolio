...
const ImportantLinks = ({ href, text }: { href: string; text: string }) => {
  return (
...
const FormAndCopyRightSection = () => {
  const pathname = usePathname();

  return (
    <div className=" text-white text-xl bg-gray-900 py-8">
      <div className="max-w-[1350px] mx-auto grid grid-cols-4 gap-10 px-4 lg:px-20 md:px-14 xl:px-[122px]">
        {pathname !== "/contact/" && (
        ...
        >
          <h2 className={`font-edu-nsw mb-3 text-3xl`}>What&apos;s next?</h2>
          <h3 className="text-2xl mb-3">Let&apos;s connect</h3>
          <p className="first-letter:text-5xl">
            If you have any opportunity, suggestion or feedback we would love to
            hear from you! Please feel free to reach out to us using the contact
            form or our email address.
          </p>
...
export default FormAndCopyRightSection;
